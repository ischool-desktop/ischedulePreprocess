...
namespace Sunset.NewCourse
{
    public static class RepObj
    {
        ...
        static public List<StudObj> GetStudentByClassID(List<SimpleCourse> NewCourses)
        {
            ...
            #region 若是有班級系統編號才進行判斷
            if (!K12.Data.Utility.Utility.IsNullOrEmpty(CourseClassID))
            {
