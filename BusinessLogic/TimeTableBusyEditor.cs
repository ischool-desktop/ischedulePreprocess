    ...
    public class TimeTableBusyEditor
    {
        ...
        public void SetTimeTableSecs(List<TimeTableSec> TimeTableSecs)
        {
            try
            {
                ...
                for(int i=1;i<=Weekdays.Max();i++)
                    grdEditor.Columns.Add("col" + i, GetWeekDayText(i));
            ...
            catch (Exception e)
            {
                ...
                MessageBox.Show("切換時間表時發生問題，訊息如下：" + System.Environment.NewLine + e.Message);
            }
        }
        ...
        public void SetPeriods(List<Period> vPeriods)
        {
            ...
            catch (Exception e)
            {
                ...
                MessageBox.Show("填入不排課時段發生問題，訊息如下：" + System.Environment.NewLine + e.Message);
            }
        }
