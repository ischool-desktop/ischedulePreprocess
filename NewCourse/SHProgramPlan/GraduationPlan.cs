...
namespace Sunset.NewCourse
{
    ...
    //                DSResponse resp = new DSResponse();// QueryGraduationPlan.GetGraduationPlan();
    ...
    //            catch (Exception exc)
    //            {
    //                SmartSchool.ErrorReporting.ReportingService.ReportException(new Exception("取得課程規劃表資料時發生錯誤。"));
    //            }
    //        }
    //        _LoadingEvent.Set();
    //    }
    ...
    //            catch (Exception exc)
    //            {
    //                SmartSchool.ErrorReporting.ReportingService.ReportException(new Exception("取得班級使用課程規劃表資料時發生錯誤。"));
    //            }
    //        }
    ...
    //            catch (Exception exc)
    //            {
    //                SmartSchool.ErrorReporting.ReportingService.ReportException(new Exception("取得學生使用課程規劃表資料時發生錯誤。"));
    //            }
    //        }
    ...
    //            catch (Exception exc)
    //            {
    //                SmartSchool.ErrorReporting.ReportingService.ReportException(new Exception("取得學生使用課程規劃表資料時發生錯誤。", exc));
    //            }
    //        }
    ...
    {
        private SchedulerProgramPlan _OldInfo, _NewInfo;
        public UpdateGraduationPlanEventArgs()
        {

        }
        public UpdateGraduationPlanEventArgs(SchedulerProgramPlan oldInfo, SchedulerProgramPlan newInfo)
        {
            _OldInfo = oldInfo;
            _NewInfo = newInfo;
        }
        public SchedulerProgramPlan OldInfo
        {
            get { return _OldInfo; }
            set { _OldInfo = value; }
        }
        public SchedulerProgramPlan NewInfo
        {
            get { return _NewInfo; }
            set { _NewInfo = value; }
        }
