...
//        private List<ClassRecord> _classes;

//        public CreateClassCourseForm(List<ClassRecord> classes)
//        {
//            InitializeComponent();
...
//                        //viewer.SetColumns(className, new List<string>(new string[] { errMsg }));
//                    }
//                    viewer.Show();
//                }
//                else
...
//            int schoolyear = K12.Data.Int.Parse(objs[0] as string);
//            int semester = K12.Data.Int.Parse(objs[1] as string);
...
//            foreach (ClassRecord cla in _classes)
//                classIDs.Add(cla.ID);

//            Dictionary<string, List<CourseRecord>> classExistCourses = new Dictionary<string, List<JHSchool.Data.JHCourseRecord>>();
//            List<CourseRecord> orphanCourse = new List<CourseRecord>();

//            foreach (CourseRecord course in Course.SelectBySchoolYearAndSemester(schoolyear, semester))
//            {
...
//                    classExistCourses.Add(course.RefClassID, new List<CourseRecord>());
...
//                foreach (CourseRecord course in classExistCourses[cla.ID])
//                {
//                    if (course.Subject == subject)
//                        errors.Add(cla.Name + "：已有相同科目(" + subject + ")的課程。");
//                }

//                foreach (CourseRecord course in orphanCourse)
//                {
...
//            foreach (ClassRecord cla in _classes)
//            {
//                K12CourseRecord newCourse = new K12CourseRecord();
...
//                classNewCourse.Add(cla.ID, Course.Insert(newCourse));
//                counter++;
...
//                foreach (StudentRecord stu in cla.Students)
//                {
...
//        private int SortClassesByClassName(ClassRecord x, ClassRecord y)
//        {
...
//            try
//            {
//                int schoolyear = K12.Data.Int.Parse(School.DefaultSchoolYear);
//                int semester = K12.Data.Int.Parse(School.DefaultSemester);
