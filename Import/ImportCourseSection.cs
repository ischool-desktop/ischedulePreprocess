...
namespace Sunset
{
    ...
    /// 匯入課程分段
    /// </summary>
    public class ImportCourseSection : ImportWizard
    {
        ...
        {
            return "http://sites.google.com/a/kunhsiang.com/sunset/home/yan-zheng-gui-ze/CourseSection.xml";
        }
        ...
        public override string Import(List<IRowStream> Rows)
        {
            ...
            //要新增的課程分段物件列表
            List<CourseSection> InsertRecords = new List<CourseSection>();
            ...
            foreach (IRowStream Row in Rows)
            {
                ...
                if (!string.IsNullOrEmpty(CourseID))
                {
                    ...
                    CourseSection vCourseSection = new CourseSection();
            ...
            lock (mLock)
            {
                ...
                if (DeleteCourseIDs.Count > 0)
                {
                    ...
                    List<CourseSection> CourseSections = mHelper.Select<CourseSection>(strCondition);
