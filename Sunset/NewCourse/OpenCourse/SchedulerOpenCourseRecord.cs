...
namespace Sunset.NewCourse
{
    ...
    /// 預開課程記錄物件
    /// </summary>
    public class SchedulerOpenCourseRecord
    {
        /// <summary>
        /// 建構式
        /// </summary>
        ...
        public SchedulerOpenCourseRecord(ProgramSubject Subject
            , string SchoolYear
            , string ClassName)
        {
    ...
    /// 比較預開課程是否相同
    /// </summary>
    public class SchedulerOpenCourseRecordComparer : IEqualityComparer<SchedulerOpenCourseRecord>
    {
        /// <summary>
        /// 比較兩個預開課程是否相同
        /// </summary>
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        public bool Equals(SchedulerOpenCourseRecord x, SchedulerOpenCourseRecord y)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(SchedulerOpenCourseRecord obj)
        {
