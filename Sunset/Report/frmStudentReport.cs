...
namespace Sunset
{
    ...
    public partial class frmStudentReport : FISCA.Presentation.Controls.BaseForm
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            strBuilder.Append("SELECT student.id AS StudentID,student.student_number as StudentNumber,student.name as StudentName,course.id AS CourseID,course.course_name AS CourseName,class.id AS ClassID,class.class_name AS ClassName,teacher.id AS TeacherID, teacher.teacher_name AS TeacherName, $scheduler.classroom.uid AS ClassroomID, $scheduler.classroom.name AS ClassroomName, $scheduler.location.uid AS LocationID, $scheduler.location.name AS LocationName,  $scheduler.course_section.length AS Length,  $scheduler.course_section.period AS Period,$scheduler.course_section.weekday AS Weekday ");
