    ...
    public partial class CampusConfiguration<T> : ConfigurationItem
    {
        ...
        private void Refill()
        {
            ...
            BGW.RunWorkerCompleted += delegate
            {
                ...
                {
                    int NewRowIndex = grdNameList.Rows.Add(Name);

                    if (Name.Equals(SelectedName))
                        grdNameList.Rows[NewRowIndex].Selected = true;
                    else 
                        grdNameList.Rows[NewRowIndex].Selected = false;
                }
