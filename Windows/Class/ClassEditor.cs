    ...
    public partial class ClassEditor : UserControl, IContentEditor<ClassPackage>
    {
        ...
        public ClassPackage Content
        {
            get
            {
                ...
                mClassPackage.Class.ClassCode = textBoxX1.Text;
                mClassPackage.Class.Note = textBoxX2.Text;
                #endregion
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    if (mClassPackage.Class != null)
                    {
                        ...
                        textBoxX1.Text = mClassPackage.Class.ClassCode;
                        textBoxX2.Text = mClassPackage.Class.Note;
                    }
