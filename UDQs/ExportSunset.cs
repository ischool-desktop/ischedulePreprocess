...
namespace Sunset
{
    ...
    public class ExportSunset
    {
        ...
        public static void ExportTeacherEx_New()
        {
            ...
            QueryExport.Execute("教師", string.Format("select {0},{1},{2},{3},{4} from $scheduler.teacher_ex order by $scheduler.teacher_ex.teacher_name,$scheduler.teacher_ex.nickname", sql1, sql2, sql3, sql4, sql5));
        }
