...
namespace Sunset
{
    ...
    /// </summary>
    public class SchedulerCourseNameCheck : IRowVaildator   
    {
        ...
        /// </summary>
        public SchedulerCourseNameCheck()
        {
            mTask = Task.Factory.StartNew(() =>
            {
                ...
                DataTable Table = Helper.Select("select course_name,school_year,semester from $scheduler.scheduler_course_extension");
